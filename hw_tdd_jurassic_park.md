...
- A name
- A ticket price
- A collection of dinosaurs  ////// collection of passengers

A park must be able to:

- Add a dinosaur to its collection of dinosaurs  // create a new dinobot and add it to the list of dinos
- Remove a dinosaur from its collection of dinosaurs // think about what is being returned in general
- Find the dinosaur that attracts the most visitors
- Find all dinosaurs of a particular species   // pop? ive lost my place. splice? yesterday notes. splice takes index position. 
- Calculate the total number of visitors per day
- Calculate the total number of visitors per year
- Calculate the total revenue from ticket sales for one year


                // return full dinosaur object. look through list of dinosaurs. 
### Extensions
